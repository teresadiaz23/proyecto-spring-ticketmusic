package com.salesianostriana.dam.ticketmusic.upload;
...
import com.salesianostriana.dam.ticketmusic.upload.model.ImagenEntity;
import com.salesianostriana.dam.ticketmusic.upload.model.ImagenEntityRepository;
...
public class DBStorageService implements StorageService<ImagenEntity, Long> {
	...
	public DBStorageService(
			...
			@Value("${image.max-size:300}") int mS,
